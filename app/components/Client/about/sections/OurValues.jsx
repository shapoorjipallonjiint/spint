...
const OurValues = ({data}) => {
  ...
  return (
    ...
    <section className="pt-text30 pb30 relative overflow-hidden" ref={sectionRef}>
      <div className="absolute -bottom-40 lg:bottom-0 right-0 lg:-right-25  xl:-right-40  2xl:-right-25 3xl:right-0 z-[-1] w-[152px] h-full sm:w-[232px] sm:h-full lg:w-[432px] lg:h-[607px]">
