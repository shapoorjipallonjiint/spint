...
const Environmental = ({data}) => {
  ...
  return (
    ...
    <section className="pt-text30 pb30 relative overflow-hidden" ref={sectionRef}>
      <div className={`absolute -bottom-10 lg:bottom-40 ${isArabic ? "left-0 lg:-left-25  xl:-left-40  2xl:-left-25 3xl:left-0 -scale-x-100" : "right-0 lg:-right-25  xl:-right-40  2xl:-right-25 3xl:right-0"} z-[-1] w-[152px] h-full sm:w-[232px] sm:h-full lg:w-[432px] lg:h-[607px]`}>
      ...
      <div className="container">
        ...
        <div className="lg:max-w-[80%] 2xl:max-w-[74.51%] border-t border-black/20">
          {t.items.map((item, index) => (
            ...
            <div className={`group grid lg:grid-cols-[1.2fr_1.2fr_auto] py-2 2xl:py-[16px] cursor-pointer border-b border-black/20  transition-all duration-300
        ...
        <h4 className="text-29 pt-[40px] 3xl:pt-[70px] max-w-[75%]">At Shapoorji Pallonji International, safety is more than a policy. It is a promise of reliability, quality, and care.</h4>
      </div>
    </section>
  );
};
