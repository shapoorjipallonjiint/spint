                    ...
                    <AnimatePresence>
                        ...
                        >
                            ...
                            <div className="flex justify-between items-center p-4 bg-zinc-900 border-b border-white/10 text-white">
                                <div>
                                <h3 className="font-medium">{items[itemIndex].fileName} - {items[itemIndex].pdfUrl[pdfIndex].name}</h3>
                                <p className="text-xs text-white/50">Document {pdfIndex + 1} of {items[itemIndex].pdfUrl.length}</p>
                                </div>
                            ...
                            <iframe
                                ...
                                src={`${items[itemIndex].pdfUrl[pdfIndex].url}#toolbar=0`}
