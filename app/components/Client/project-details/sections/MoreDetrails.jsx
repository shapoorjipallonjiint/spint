    ...
    <section className="relative overflow-hidden" ref={sectionRef}>
      <div className="pt-8 pb-9 xl:py-15 2xl:py-22  3xl:py-[80px]  relative bg-f5f5 ">
        <div className="container relative">
          ...
          >
            <div className={`flex  justify-between items-center ${t.scopeDescription && t.scopeDescription !== "<p></p>" ? "border-b border-black/20" : ""}`}>
              <div className={`relative z-20 ${t.scopeDescription && t.scopeDescription !== "<p></p>" ? "mb-3 xl:mb-7 3xl:mb-[38px]" : ""}`}>
                  ...
                  {normalizeDescription(t.description)
                    ...
                    .map((paragraph, index) => (
                      <motion.p
                        ...
                        // className={`text-19 font-light text-paragraph mb-3 xl:mb-5 3xl:mb-[25.4px] last:mb-0 ${t.scopeDescription && t.scopeDescription !== "<p></p>" ? "" : "last:mb-6 last:lg:mb-10 last:2xl:mb-[80px]"}`}
                        className={`text-19 font-light text-paragraph mb-3 xl:mb-5 3xl:mb-[25.4px] last:mb-0 `}
                      >
                        {paragraph}
                      </motion.p>
                    ))}
          ...
          {t.scopeDescription && t.scopeDescription !== "<p></p>" && (
            <div
              className={`2xl:max-w-[1008px] 3xl:max-w-[1208px] ${isArabic ? "mr-auto" : "ml-auto"}  mt-3 xl:mt-5 3xl:mt-[28.4px]`}
            >
              {/* <div className="flex  justify-between items-center border-b border-black/20"> */}
              <div className="flex justify-between items-center">
                <div className="relative z-20">
                  <H2Title
                    titleText="Scope of MEP Work"
                    marginClass="mb-3 lg:mb-7"
                  />
                  <div
                    dangerouslySetInnerHTML={{
                      __html: normalizeHtml(t.scopeDescription),
                    }}
                    className="project-scope-description"
                  ></div>
                </div>
              </div>
            </div>
