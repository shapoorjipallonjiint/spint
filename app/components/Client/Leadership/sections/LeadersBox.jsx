       ...
       <div className="border-b border-cmnbdr relative overflow-hidden mb-5 xl:mb-20 2xl:mb-25">
          <div className="grid items-center grid-cols-1 lg:grid-cols-2 3xl:grid-cols-[739px_auto] pt25 3xl:pt-18 pb-10 3xl:pb-[135px]">
            <div className="relative flex flex-col justify-end" ref={imageContainerRefOne}>
              <MotionImage height={1920} width={1000} style={{ y: imageY }} variants={fadeIn(0.6)} initial="hidden" whileInView="show" viewport={{amount: 0.1, once: true}} src={normalizedData[0].image} alt={normalizedData[0].name} className="relative w-fit object-contain mr-auto ml-3 lg:ml-auto lg:mr-2 z-20 h-[250px] xs:h-[400px] xl:h-[450px] 2xl:h-[600px] 3xl:h-[735.62px]  max-w-[710px]" />
            ...
            <div className="pt-5 xl:pt-8 2xl:pt-12 3xl:pt-[68.5px] lg:pl-8  xl:pl-15 2xl:pl-17 3xl:pl-[97px]">
              ...
              <motion.h3 variants={moveUp(0.4)} initial="hidden" whileInView="show" viewport={{amount: 0.1, once: true}} className="text-29 font-[400] leading-[1.344827586206897] text-paragraph mb-6 lg:mb-8 xl:mb-[45px]">{normalizedData[0].position}</motion.h3>
              <div 
                ref={scrollRef1}
                className="lg:max-h-[385px] lg:overflow-y-auto scrollbar-thin touch-pan-y"
              ...
              >
                {normalizedData[0].desc.map((item, index) => (
                  <motion.div variants={moveUp(0.6 + 0.2*index)} initial="hidden" whileInView="show" viewport={{amount: 0.1, once: true}} key={index} className="">
                    <p className="text-19 leading-[1.473684210526316] text-paragraph font-[400] lg:max-w-[52ch] mb-4 2xl:mb-7">{item}</p>
                  </motion.div>
                ))}
              </div>
            </div>
          </div>
          <div className=" lg:mt-[100px] 2xl:mt-[205px] 3xl:mt-[165px] grid items-center grid-cols-1 lg:grid-cols-2 3xl:grid-cols-[793px_auto] gap-6 md:gap-10 xl:gap-15 2xl:gap-17 3xl:gap-[88px] pb-10 xl:pb-25 3xl:pb-[135px]">
            ...
            <div className="pt-5 xl:pt-8 2xl:pt-12 3xl:pt-[63.89px] lg:order-1">
              ...
              <div 
                ref={scrollRef2}
                className="lg:max-h-[350px] 2xl:max-h-[490px] lg:overflow-y-auto scrollbar-thin touch-pan-y"
                style={{ overscrollBehavior: 'contain' }}
                onScroll={handleScroll}
                onWheel={handleWheel}
                onTouchMove={handleTouchMove}
