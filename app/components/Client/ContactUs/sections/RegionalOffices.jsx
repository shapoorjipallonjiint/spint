...
const RegionalOffices = ({ data }) => {
  ...
  px-0 md:px-5 p-5 py-8 3xl:px-15 3xl:pb-15
  md:border-t border-b border-[#CCCCCC]
  ${
      isArabic
          ? `
        md:border-l
        2xl:[&:nth-child(3n)]:border-l-0
        no-border-left no-pr0
      `
          : `
odd:md:border-r-0 odd:2xl:border-r
        md:border-r no-border-right no-pl0
      `
  }
`}
                        >
