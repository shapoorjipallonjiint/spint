            ...
            
              {
                office.phone || office.fax ? (
                  <div className="bg-f5f5 p-5 2xl:px-7 3xl:px-10 3xl:pt-[34px] 3xl:pb-[36px] max-w-[446px]">
                    <div className="flex flex-wrap justify-between mb-5 lg:mb-[35px] ">
                      {office.phone ? (
                        <div>
                          ...
                          <div>
                            {/* {office.phone.split('').map((phone, index) => ( */}
                              <p key={index} className=" text-16 3xl:text-19 font-bold leading-[1.53] ">{office.phone}</p>
                            {/* ))} */}
                          </div>
                        </div>
                      ) : null}
                    ...
                    <Link href={office.location || ""} traget="blank">
