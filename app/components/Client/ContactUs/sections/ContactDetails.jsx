...
import { FIRST_SECTION_ZONES } from "@/app/(admin)/admin/(auth)/community-engagement/page";
      ...
      <div className="container">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[0.6fr_1fr] xl:grid-cols-[1fr_1.6fr] 2xl:grid-cols-[auto_650px] 3xl:grid-cols-[auto_866px] gap-y-8 lg:gap-x-8 3xl:gap-[131px]">
          <div className="lg:pt-[56px]" >
            <motion.h3 variants={moveUp(0.4)} initial="hidden" whileInView="show" viewport={{ amount: 0.2, once: true }} className="text-19 font-light text-paragraph mb-3 lg:mb-6 ">{data?.firstSection?.title}</motion.h3>
            <motion.p variants={moveUp(0.4)} initial="hidden" whileInView="show" viewport={{ amount: 0.2, once: true }} className="text-29 font-bold leading-[1.31] ">{data?.firstSection?.name}</motion.p>
            <motion.p variants={moveUp(0.6)} initial="hidden" whileInView="show" viewport={{ amount: 0.2, once: true }} className="text-paragraph text-20 xl:text-26 3xl:text-29 font-light leading-[1.35] max-w-[25ch]">{data?.firstSection?.address}</motion.p>
            <div className="flex flex-col sm:flex-row  gap-5 md:gap-15 xl:gap-[100px] 3xl:gap-[85px] my-6 lg:my-10 xl:my-15 2xl:my-20">
              <div>
                ...
                <motion.p variants={moveUp(0.8)} initial="hidden" whileInView="show" viewport={{ amount: 0.2, once: true }} className="text-black text-19 xl:text-26 3xl:text-29 font-light leading-[1.31]">{data?.firstSection?.phone}</motion.p>
              </div>
              <div>
                ...
                <motion.p variants={moveUp(0.8)} initial="hidden" whileInView="show" viewport={{ amount: 0.2, once: true }} className="text-black text-19 xl:text-26 3xl:text-29 leading-[1.31]   font-light">{data?.firstSection?.email}</motion.p>
              </div>
            </div>
              ...
              <div className="flex gap-[6px] items-center cursor-pointer">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="15" height="19" viewBox="0 0 15 19" fill="none">
                  <g clipPath="url(#clip0_3796_2437)">
                    <path d="M7.49886 1.06396C3.95699 1.06396 1.08594 3.91705 1.08594 7.43674C1.08594 8.72329 1.47165 9.91985 2.12904 10.9198L7.43513 17.7258L12.8653 10.9198C13.5261 9.91652 13.9084 8.71996 13.9084 7.43674C13.9151 3.91705 11.0407 1.06396 7.49886 1.06396Z" stroke="#30B6F9" strokeWidth="2" strokeMiterlimit="10" strokeLinecap="round" />
                    <path d="M7.5 10C8.88071 10 10 8.88071 10 7.5C10 6.11929 8.88071 5 7.5 5C6.11929 5 5 6.11929 5 7.5C5 8.88071 6.11929 10 7.5 10Z" stroke="#30B6F9" strokeWidth="2" strokeMiterlimit="10" strokeLinecap="round" />
                  </g>
                  <defs>
          ...
          <div className="bg-primary px-5 pt-8 pb-9 lg:p-8 xl:p-10 3xl:p-[70px] 3xl:pt-[59px]">
            ...
            <form>
              <div className="grid sm:grid-cols-2 gap-5 2xl:gap-50px w-full mb-6 xl:mb-8 3xl:mb-15">
                <motion.div variants={moveUp(0.4)} initial="hidden" whileInView="show" viewport={{ amount: 0.2, once: true }} className="relative w-full ">
                  <input id="name" type="text" className="peer w-full bg-transparent text-19 font-extralight border-0 border-b border-white/30 py-3 
                            focus:border-white text-white focus:outline-none placeholder-transparent" placeholder=" " />
                  <label htmlFor="name" className="absolute left-0 top-1/2 -translate-y-1/2  text-white text-19 font-extralight transition-all duration-200 ease-out peer-focus:top-0 peer-focus:text-xs peer-focus:text-white peer-focus:-translate-y-full peer-placeholder-shown:top-1/2 peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:text-base 2xl:peer-placeholder-shown:text-19 peer-not-placeholder-shown:top-0 peer-not-placeholder-shown:-translate-y-full peer-not-placeholder-shown:text-19 peer-not-placeholder-shown:text-white">Name*</label>
                </motion.div>

                <motion.div variants={moveUp(0.5)} initial="hidden" whileInView="show" viewport={{ amount: 0.2, once: true }} className="relative w-full ">
                  <input id="email" type="email" className="peer w-full bg-transparent text-19 font-extralight border-0 border-b border-white/30 py-3 
                            focus:border-white text-white focus:outline-none placeholder-transparent" placeholder=" " />
                  <label htmlFor="email" className="absolute left-0 top-1/2 -translate-y-1/2  text-white text-19 font-extralight transition-all duration-200 ease-out peer-focus:top-0 peer-focus:text-xs peer-focus:text-white peer-focus:-translate-y-full peer-placeholder-shown:top-1/2 peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:text-base 2xl:peer-placeholder-shown:text-19 peer-not-placeholder-shown:top-0 peer-not-placeholder-shown:-translate-y-full peer-not-placeholder-shown:text-19 peer-not-placeholder-shown:text-white">Email*</label>
                </motion.div>
              </div>
              <div className="grid sm:grid-cols-2 gap-5 2xl:gap-12 w-full mb-6 xl:mb-8 3xl:mb-15">
                <motion.div variants={moveUp(0.7)} initial="hidden" whileInView="show" viewport={{ amount: 0.2, once: true }} className="relative w-full">
                  <input id="organization" type="text" className="peer w-full bg-transparent text-19 font-extralight border-0 border-b border-white/30 py-3 
                            focus:border-white text-white focus:outline-none placeholder-transparent" placeholder=" " />
                  <label htmlFor="organization" className="absolute left-0 top-1/2 -translate-y-1/2  text-white text-19 font-extralight transition-all duration-200 ease-out peer-focus:top-0 peer-focus:text-xs peer-focus:text-white peer-focus:-translate-y-full peer-placeholder-shown:top-1/2 peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:text-base 2xl:peer-placeholder-shown:text-19 peer-not-placeholder-shown:top-0 peer-not-placeholder-shown:-translate-y-full peer-not-placeholder-shown:text-19 peer-not-placeholder-shown:text-white">Your Organization*</label>
                </motion.div>


                <motion.div variants={moveUp(0.8)} initial="hidden" whileInView="show" viewport={{ amount: 0.2, once: true }} className="relative w-full">
                  <input id="country" type="text" className="peer w-full bg-transparent text-19 font-extralight border-0 border-b border-white/30 py-3 
                            focus:border-white text-white focus:outline-none placeholder-transparent" placeholder=" " />
                  <label htmlFor="country" className="absolute left-0 top-1/2 -translate-y-1/2  text-white text-19 font-extralight transition-all duration-200 ease-out peer-focus:top-0 peer-focus:text-xs peer-focus:text-white peer-focus:-translate-y-full peer-placeholder-shown:top-1/2 peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:text-base 2xl:peer-placeholder-shown:text-19 peer-not-placeholder-shown:top-0 peer-not-placeholder-shown:-translate-y-full peer-not-placeholder-shown:text-19 peer-not-placeholder-shown:text-white">Country*</label>
                </motion.div>
              </div>
              <motion.div variants={moveUp(0.9)} initial="hidden" whileInView="show" viewport={{ amount: 0.2, once: true }} className="relative mb-6 xl:mb-8 3xl:mb-15">
                {/* Floating Label */}
                <label
                  className={`absolute left-0 transition-all duration-200 text-white text-base 2xl:text-19 font-extralight pointer-events-none ${subject ? "top-0 -translate-y-full text-xs text-white" : "top-1/2 -translate-y-1/2 "}`}
                >
                  Subject*
                </label>
              ...
              <motion.div variants={moveUp(1)} initial="hidden" whileInView="show" viewport={{ amount: 0.2, once: true }} className="relative mb-50px">
                <textarea
                  id="message"
                  rows="3"
              ...
              >
                <div className="relative p-[1px] rounded-full cursor-pointer">
                  ...
                  <div className="relative rounded-full bg-[#5974b7] py-2 px-4 text-white text-[16px]">
                    Send Message
                  </div>
                </div>
