  ...
  return (
    <section ref={sectionRef}
      ...
      <motion.div className="hidden xl:block flex-shrink-0">
        <motion.img style={{ y: shapeY }} src={"/assets/images/svg/svsv.svg"} alt="logo-svg" width={229} height={320} className="2xl:w-[229px] 2xl:h-[320px] left-[-80px] 2xl:left-auto  object-contain absolute" />
      </motion.div>  
