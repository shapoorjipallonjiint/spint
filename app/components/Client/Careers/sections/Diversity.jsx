...
const DiversitySection = ({ data }) => {
    ...
    const { title, subtitle, images, arrowImage } = data;
...
<div
  className={`
    ...
    ${isArabic ? "left-10 2xl:left-20 -scale-x-100" : "right-10 2xl:right-20"}
    w-[220px] h-[308px]
...
>
  ...
  />
            ...
            {/* Heading */}
            <div className="flex flex-col w-full max-w-[840px] mx-auto text-left mb-50px px-[15px]">
            ...
            <div
                className="
                  ...
                  h-[420px] md:h-[520px] 2xl:h-[624px] overflow-visible
                "
            >
