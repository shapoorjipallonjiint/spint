        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 3xl:grid-cols-[830px_auto] gap-5 lg:gap-0">
          <div >
            <h1 className="text-70 font-light leading-[1.071428571428571]">
              <SplitTextAnimation children={"Accreditations"} staggerDelay={0.2} animationDuration={0.8} delay={0.2}/>
            </h1>
          </div>
          <div className={isArabic ? "lg:pr-8  xl:pr-15 2xl:pr-17 3xl:pr-0" : "lg:pl-8  xl:pl-15 2xl:pl-17 3xl:pl-0"}>
            <motion.h3 variants={moveUp(0.4)} initial="hidden" whileInView="show" viewport={{ amount: 0.2, once: true }} className="text-29 leading-[1.344827586206897] font-light mb-3 xl:mb-5">Guided by Vision, Driven by Excellence</motion.h3>
