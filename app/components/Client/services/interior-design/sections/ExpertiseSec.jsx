...
const ExpertiseSec = ({ data }) => {
    ...
    return (
        <section className="relative pt-text30 overflow-hidden" ref={sectionRef}>
            <div className="absolute top-75 lg:top-20 xl:top-30 2xl:top-40 3xl:top-50 right-0 lg:left-[-85px] 3xl:left-0 w-[158px] lg:w-[558px] h-[725px]">
                <motion.img style={{ y: shapeY }} src={assets.mainShape2} alt="" />
            </div>
