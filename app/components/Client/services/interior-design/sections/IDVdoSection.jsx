        ...
        <section className="relative sectm-100 pb30" ref={sectionRef}>
            <div className="absolute inset-0 z-10 hidden lg:block">
                <div className="container">
                    <motion.div variants={moveUp(0.2)} initial="hidden" whileInView="show" viewport={{ amount: 0.2, once: true }} className="flex flex-col 3xl:ml-[8%] lg:-mt-[2%] 3xl:-mt-6">
                        <Image src={"/assets/images/leadership/core-team/t1.png"} alt="" width={300} height={350} className="object-cover w-[200px] h-[210px] xl:w-[200px] xl:h-[210px] 2xl:w-[250px] 2xl:h-[250px] 3xl:w-[320px] 3xl:h-[300px]" />
                        ...
                        <motion.p variants={moveUp(0.42)} initial="hidden" whileInView="show" viewport={{ amount: 0.2, once: true }} className="text-16 font-light leading-[1.2]">Head – Interior Design</motion.p>
                    </motion.div>
                </div>
            </div>
