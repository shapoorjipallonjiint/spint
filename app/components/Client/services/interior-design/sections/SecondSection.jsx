...
const SecondSection = ({ data }) => {
    ...
    useEffect(() => {
        ...
        gsap.to(overlay, {
            xPercent: isArabic ? -100 : 100, // RTL ↔ LTR
            duration: 2.7,
            ease: "expo.out",
            scrollTrigger: {
        ...
        <section className="relative pt-text90 pb25 bg-primary text-white overflow-hidden" ref={sectionRef}>
            ...
            <div className={`absolute bottom-[-100px] lg:bottom-[-52px] ${isArabic ? "left-0 -scale-x-100" : "right-0"}`}>
                <MotionImage
                    ...
                    className="object-contain w-[200px] lg:w-[325px] 3xl:w-[425px] h-[594px]"
                    alt=""
                />
            </div>
                        ...
                        <div>
                            ...
                            >
                                <Image
                                    ...
                                    width={65}
                                    height={65}
                                    className="h-10 w-auto xl:h-[50px] 3xl:h-[65px] object-contain"
                                />
                            </motion.div>
                            <motion.h3
                                variants={moveUp(0.2 * index)}
