                ...
                <SwiperSlide key={i}>
                  <div className="overflow-hidden  h-full">
                    <div className="relative overflow-hidden" ref={imageContainerRefTwo}>
                      <MotionImage width={500} height={400} variants={moveUp(0.1 * i)} initial="hidden" whileInView="show" viewport={{ amount: 0.2, once: true }} src={item.image} alt={item.imageAlt} className="w-full h-[200px] md:h-[250px] 2xl:h-[333px] scale-y-110 object-cover" />
                    </div>
                    <div className="pt-3 md:pl-4 lg:pt-8 lg:pl-8 lg:pb-8 2xl:pt-10 2xl:pl-10 2xl:pb-12 md:border-l border-black/20">
                      ...
                      <p className="text-14 xl:text-19 font-extralight font-paragraph leading-[1.5]">{item.description}</p>
                    </div>
                  </div>
                </SwiperSlide>
              ))}
