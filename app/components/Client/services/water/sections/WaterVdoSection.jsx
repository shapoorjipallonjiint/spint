      ...
      <div className="absolute inset-0 z-10 hidden lg:block">
        <div className="container">
          <motion.div variants={moveUp(0.2)} initial="hidden" whileInView="show" viewport={{ amount: 0.2, once: true }} className="flex flex-col 3xl:ml-[8%] 3xl:-mt-6">
            ...
            <motion.p variants={moveUp(0.3)} initial="hidden" whileInView="show" viewport={{ amount: 0.2, once: true }} className="text-20 font-medium mt-1">Murthy Satyanarayana</motion.p>
            <motion.p variants={moveUp(0.42)} initial="hidden" whileInView="show" viewport={{ amount: 0.2, once: true }} className="text-16 font-light leading-[1.2]">Head – Water Division</motion.p>
          </motion.div>
        </div>
      </div>
