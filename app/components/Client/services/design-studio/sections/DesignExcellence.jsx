...
const DesignExcellence = ({ data }) => {
  ...
  return (
    <section className="relative overflow-hidden pt30 3xl:pt-[161px] pb30" ref={sectionRef}>
      <div className="absolute bottom-[-140px] pt30 3xl:pt-[161px] left-[-120px] xl:left-0 h-full w-full z-0"><MotionImage width={1500} height={1000} style={{y:shapeY}} src={assets.mainShape2} alt="" className="w-[30%] 2xl:w-[425px] h-auto max-w-[425px] object-contain" /></div>
      <div className="container">
        <div className="w-full max-w-[700px] xl:max-w-[700px] 2xl:max-w-[900px] 3xl:max-w-[1207px] ml-auto flex flex-col gap-5 xl:gap-0">
          <div className="mb-0 md:mb-6 2xl:mb-12 3xl:mb-18 order-2 xl:order-1">
              ...
              <motion.p variants={moveUp(0.4)} initial="hidden" whileInView="show" viewport={{ amount: 0.2, once: true }}  className="text-19 leading-[1.473684210526316] font-light text-paragraph max-w-3xl">{data.description}</motion.p>
          </div>
          <div className="order-1 xl:order-2 relative overflow-hidden" ref={imageContainerRefTwo}>
            <div ref={imageContainerRefOne} className="relative">
              <MotionImage style={{ y: imageY }} src={data.image} alt={data.imageAlt} width={1270} height={470} className="w-full h-[200px] md:h-[300px] lg:h-[350px] 2xl:w-[1270px] 2xl:h-[470px] scale-110 lg:scale-150 xl:scale-110 object-cover" />
            </div>
