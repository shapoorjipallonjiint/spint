...
const ExpertiseSec = ({data}) => {
  ...
  return (
    <section className="relative pt-text90 pb25 bg-primary text-white overflow-hidden" ref={sectionRef}>
      ...
      <div className="hidden md:block absolute bottom-0 right-0 w-[280px]  lg:w-[519px]  md:w-[350px] md:h-[500px]  2xl:w-[519px] h-[525px] lg:h-[725px]"><MotionImage width={1500} height={1000} style={{y:shapeY}} src={assets.mainShape} alt="" /></div>
