...
const ProjectForm = ({ editMode }: { editMode?: boolean }) => {
    ...
    const fetchLocation = async () => {
        try {
            const response = await fetch("/api/admin/home/countries");
            if (response.ok) {
                const data = await response.json();
                    ...
                    <div className="p-5 rounded-md flex flex-col gap-5">
                        <div>
                            ...
                            <Input
                                type="text"
                                placeholder="Title"
                                {...register("firstSection.title", { required: "Title is required" })}
                            />
                        ...
                        <div>
                            ...
                            <Input
                                ...
                                {...register("firstSection.subTitle", { required: "Sub Title is required" })}
                            />
                            {errors.firstSection?.subTitle && (
                                <p className="text-red-500">{errors.firstSection.subTitle.message}</p>
                            )}
                        </div>
                    ...
                    <div className="p-5 rounded-md flex flex-col gap-5">
                        {/* <div>
                            ...
                            <Input
                                type="text"
                                placeholder="Title"
                                {...register("secondSection.title", { required: "Title is required" })}
                            />
                        ...
                        <div className="flex flex-col gap-2">
                            ...
                            {errors.secondSection?.location && (
                                <p className="text-red-500">{errors.secondSection.location.message}</p>
                            )}
                        </div>
                        ...
                        <div className="flex flex-col gap-2">
                            ...
                            {errors.secondSection?.sector && (
                                <p className="text-red-500">{errors.secondSection.sector.message}</p>
                            )}
                        </div>
                            ...
                            <div className="border p-2 rounded-md flex flex-col gap-5">
                                ...
                                <div className="flex justify-end">
                                    <Button
                                        ...
                                        addItem
                                        onClick={() =>
                                            secondSectionAppend({ key: "", value: "", key_ar: "", value_ar: "" })
                                        }
                                    >
                                        Add Item
                                    </Button>
                            ...
                            <div className="border p-2 rounded-md flex flex-col gap-5">
                                        ...
                                        <div className="flex flex-col gap-2">
                                            <div className="flex flex-col gap-2">
                                                ...
                                                <Input
                                                    type="text"
                                                    placeholder="Number"
                                                    {...register(`thirdSection.items.${index}.number`)}
                                                />
                                            </div>
                                        </div>
                                ...
                                <div className="flex justify-end">
                                    <Button
                                        ...
                                        addItem
                                        onClick={() =>
                                            thirdSectionAppend({ number: "", value: "", number_ar: "", value_ar: "" })
                                        }
                                    >
                                        Add Item
                                    </Button>
                        ...
                        <div className="flex flex-col gap-2">
                            <div className="flex flex-col gap-1">
                                ...
                                {errors.sixthSection?.title && (
                                    <p className="text-red-500">{errors.sixthSection?.title.message}</p>
                                )}
                            </div>
                            <div className="flex flex-col gap-1">
                                ...
                                {errors.sixthSection?.subTitle && (
                                    <p className="text-red-500">{errors.sixthSection?.subTitle.message}</p>
                                )}
                            </div>
                            <div className="flex flex-col gap-1">
                                ...
                                <Input
                                    placeholder="Email"
                                    {...register("sixthSection.email", {
                                        required: "Email is required",
                                    })}
                                />
                                {errors.sixthSection?.email && (
                                    <p className="text-red-500">{errors.sixthSection?.email.message}</p>
                                )}
                            </div>
                        </div>
                    </div>
            ...
            <div className="flex flex-col gap-5 rounded-md">
                <AdminItemContainer>
                    ...
                    <div className="p-5 rounded-md flex flex-col gap-5">
                        ...
                        <div>
                            <Label className="flex gap-2 items-center mb-1">Slug</Label>
                            <Input
                                disabled
                                type="text"
                                placeholder="Slug"
                            ...
                            <div>
                                ...
                                <div>
                                    ...
                                    <Input
                                        type="text"
                                        placeholder="Alt Tag"
                                        {...register("firstSection.coverImageAlt_ar")}
                                    />
                                </div>
                            </div>
                        </div>
                                        ...
                                        <div className="flex flex-col gap-2">
                                            <div className="flex flex-col gap-2">
                                                ...
                                                <Input
                                                    type="text"
                                                    placeholder="Number"
                                                    {...register(`thirdSection.items.${index}.number_ar`)}
                                                />
                                            </div>
                                        </div>
