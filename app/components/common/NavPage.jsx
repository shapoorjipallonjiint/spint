...
const NavPage = ({ isOpen }) => {
    ...
    return (
        ...
        ${
            activeMenu === item.id
                ? "opacity-100 translate-x-1" // ALWAYS visible for active
    ...
    `}
                ...
                <div className="w-[55%] h-full relative text-white">
                    ...
                    <div className={`absolute top-0 ${isOpen ? "-right-[1px]" : "right-0"}`}>
                        <img src="/assets/images/navpage/nav-right-svg.svg" alt="nav-right" />
                    </div>
                    ...
                    <motion.div
                        ...
                        initial="hidden"
                        whileInView="show"
                        className="absolute bottom-[95px] right-0 lg:right-10 3xl:right-38 flex items-center gap-4 z-10"
                    >
