...
//                         } w-[22px] h-[22px]  md:w-[30px] md:h-[30px] lg:w-[22px] lg:h-[22px] border rounded-full flex items-center justify-center `}
//                     >
//                         <img
...
const HeaderTw = ({ activeSection, setActiveSection, setIndexToScroll }) => {
    ...
    return (
        <>
            <div className={`fixed top-7 lg:top-13 ${isArabic ? "left-0 lg:left-10 3xl:left-38" : "right-0 lg:right-10 3xl:right-38"} z-50 w-full`}>
                <div className={`flex gap-8 items-center justify-between lg:justify-end ps-5 lg:ps-0`}>
                    <div className="flex justify-center items-center lg:hidden"
                        onClick={() => handleScroll('section1')}       >
                        ...
                        <a href="#">
                            <div className={`flex items-center justify-center z-[1]  cursor-pointer relative  h-[31px]  ${logostatus === true ? "bg-[#00000040] lg:bg-[#ffffff]" : "bg-[#00000040]"} rounded-[15px]`}>
                                <Image
                                    ...
                                    height={31}
                                />
                                <p className={`mb-0 font-[300] text-[16px] px-5 ${logostatus === true ? "text-[#ffffff] lg:text-[#000]" : "text-[#ffffff]"}`}>{isArabic ? "العربية" : "العربية"}</p>
                            </div>
                        </a>
                        <div
                            className="flex lg:hidden justify-center items-center "
                    ...
                    <div
                        className="hidden lg:flex cursor-pointer items-center justify-center bg-black rounded-full p-2 w-11 h-11 overflow-hidden"
                        onClick={() => {
    ...
    `}
            ...
            {/* <header className="fixed top-0 left-0 z-50 hidden lg:block"> */}
            <header className={`fixed top-0 ${isArabic ? "right-0" : "left-0"} z-20 hidden lg:block`}>
                <div className="flex">
                    <div className="flex w-[150px] h-screen">
                        {activeSection !== "section1" && (
                            <nav className="flex flex-col justify-center gap-4 opacity-0">
  ...
  ${isActive ? `font-[700] activebfr ${baseColor}` : `nonactivebfr ${baseColor}`}`}
                    ...
                    <div className={`${isArabic ? "right-spacing" : "left-spacing"} fixed h-full py-[50px]`}>
                        <div
                            ref={headerRef}
  ...
  />
                                ...
                                <div
                                    className={`flex flex-col gap-3 justify-center items-center border-t ${menuOpen ? "border-[#626262]" : "border-white/25"
                                        } cursor-pointer scrlldwn`}
                                    // onClick={() => handleScroll(nextSection.id)}
                                    onClick={() => {
                                        if (!nextSection) {
                                ...
                                >
                                    <AnimatePresence mode="wait">
                                        <motion.p
                                            ...
                                            exit={{ opacity: 0, y: -10 }}
                                            transition={{ duration: 0.35 }}
                                            className={`${menuOpen ? "text-[#626262]" : "text-white"
                                                } font-[300] text-[13px] leading-[25px] pt-3 uppercase`}
                                        >
                                            {
                                    ...
                                    {/* <img src="/assets/images/round-arrow-down-menu.svg" alt="Arrow" width={87} height={87} /> */}
                                    <div
                                        className={`flex items-center relative group ${menuOpen ? "border rounded-full border-[#626262]" : ""
                                            }`}
                                    >
                                        <Image src="/assets/images/round-circle.svg" alt="Arrow" width={87} height={87} className={`${isArabic ? "-scale-x-100" : ""}`} />
                                        <Image
                                            src="/assets/images/arrow-down.svg"
                                            alt="Arrow"
                                            width={35}
            ...
            >
                <div className="w-[35px] h-[35px] md:w-[45px] md:h-[45px] lg:w-[35px] lg:h-[35px] bg-primary flex items-center justify-center  mx-auto xs-mb-12 mb-7">
                    <div
                        className={`${menuOpen ? "border-[#626262]" : "border-white"
                            } w-[22px] h-[22px]  md:w-[30px] md:h-[30px] lg:w-[22px] lg:h-[22px] border rounded-full flex items-center justify-center `}
                    >
                        <img
                            src="../assets/images/home/downarrow.svg"
            ...
            <NavPage isOpen={menuOpen} closeMenu={() => setMenuOpen(false)} />
            <HomeMobileNavbar isOpen={mobileMenuOpen} onClose={() => setMobileMenuOpen(false)} setMobileMenuOpenSearch={setMobileMenuOpenSearch} />
            <HomeMobileNavbarSearch isOpen={mobileMenuOpenSearch} onClose={() => setMobileMenuOpenSearch(false)} navbarClose={() => setMobileMenuOpen(false)} />
        </>
    );
};
