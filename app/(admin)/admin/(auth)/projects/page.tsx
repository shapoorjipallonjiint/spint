                    ...
                    <div className='p-5 flex flex-col gap-2'>
                        ...
                        <div>
                            <div className='flex flex-col gap-2'>
                                                            ...
                                                            <Input type='text' placeholder='Title' {...register(`firstSection.items.${index}.number`)} />
                                                        </div>
                        </div>
                                                <div>
                            <div className='flex flex-col gap-2'>
                                                            <Label className='pl-3 font-bold'>Value</Label>
                                                            <Input type='text' placeholder='Title' {...register(`firstSection.items.${index}.value`)} />
                                                        </div>
                        </div>    
                                            ...
                                            <div className='flex justify-end mt-2'>
                                                <Button type='button' addItem onClick={() => firstSectionAppend({ number:"", value:"", number_ar:"", value_ar:"" })}>Add Item</Button>
                                            </div>
      ...
      <AdminItemContainer>
                    ...
                    <div className='p-5 flex flex-col gap-2'>
                        ...
                        <div>
                            <div className='flex flex-col gap-2'>
                                                            <Label className='pl-3 font-bold'>Number</Label>
                                                            <Input type='text' placeholder='Title' {...register(`firstSection.items.${index}.number_ar`)} />
                                                        </div>
                        </div>
                                                <div>
                            <div className='flex flex-col gap-2'>
                                                            <Label className='pl-3 font-bold'>Value</Label>
                                                            <Input type='text' placeholder='Title' {...register(`firstSection.items.${index}.value_ar`)} />
                                                        </div>
                        </div>    
        ...
        <div className="flex flex-col gap-2 h-screen">
          ...
          <div className="h-1/2 w-full p-5 shadow-md border-gray-300 rounded-md overflow-y-hidden bg-white">
            <div className="flex justify-between border-b-2 pb-2">
              ...
              <Dialog>
                <DialogTrigger className="bg-black text-white px-2 py-1 rounded-md" onClick={() => {setSector("");setSectorAr("")}}>Add Sector</DialogTrigger>
                <DialogContent>
                  <DialogHeader>
                    ...
                    <DialogDescription>
                      ...
                      <Input type="text" placeholder="Sector Name" value={sector_ar} onChange={(e) => setSectorAr(e.target.value)} />
              ...
              {sectorList.map((item) => (
                <div className="flex justify-between border p-2 items-center rounded-md shadow-md hover:shadow-lg transition-all duration-300" key={item._id}>
                  ...
                  <div className="flex gap-5">
                    <Dialog>
                      <DialogTrigger onClick={() => { setSector(item.name);setSectorAr(item.name_ar)}}><MdEdit /></DialogTrigger>
                      <DialogContent>
                        <DialogHeader>
