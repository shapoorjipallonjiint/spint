...
const AboutPage = () => {
    ...
    return (
        <form className="grid grid-cols-2 gap-10" onSubmit={handleSubmit(handleAddAbout)}>
            {/*English Version */}
            <div className="flex flex-col gap-5">
                                            ...
                                            <div className="flex flex-col gap-2">
                                                ...
                                                {errors.firstSection?.items?.[index]?.value && (
                                                    <p className="text-red-500">
                                                        {errors.firstSection?.items?.[index]?.value.message}
                                                    </p>
                                                )}
                                            </div>
                                        </div>
                ...
                <AdminItemContainer>
                    ...
                    <div className="p-5 rounded-md flex flex-col gap-10">
                        <div className="flex flex-col gap-6">
                            <div className="grid grid-cols-2 gap-6">
                                ...
                                <div className="flex flex-col gap-2">
                                    ...
                                    <Input placeholder="Sub Title" {...register("secondSection.subTitle")} />
                                </div>
                                ...
                                <div className="border p-3 rounded-md flex flex-col gap-4 mt-2">
                                    {secondSectionItems.map((field, index) => (
                                        ...
                                        >
                                            ...
                                            <Input
                                                placeholder="Letter"
                                                {...register(`secondSection.items.${index}.letter`)}
                                            />
                    ...
                    <div className="p-5 rounded-md flex flex-col gap-5">
                        ...
                        <div className="flex justify-end mt-2">
                            <Button
                                ...
                                addItem
                                onClick={() =>
                                    thirdSectionAppend({ title: "", description: "", title_ar: "", description_ar: "" })
                                }
                            >
                                Add Item
                            </Button>
                        ...
                        <div className="flex flex-col gap-2">
                            ...
                            <div className="flex flex-col gap-1">
                                ...
                                <Input
                                    type="text"
                                    placeholder="Title"
                                    {...register("fifthSection.buttonText", {
                                        required: "Title is required",
                                    })}
                                />
                                {errors.fifthSection?.buttonText && (
                                    <p className="text-red-500">{errors.fifthSection?.buttonText.message}</p>
                                )}
                            </div>
                            <div className="flex flex-col gap-1">
                                ...
                                {errors.fifthSection?.buttonLink && (
                                    <p className="text-red-500">{errors.fifthSection?.buttonLink.message}</p>
                                )}
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="p-5 rounded-md flex flex-col gap-10">
                        <div className="flex flex-col gap-6">
                            <div className="grid grid-cols-2 gap-6">
                                <div className="flex flex-col gap-2">
                                    <Label className="font-bold">Title</Label>
                                    <Input placeholder="Title" {...register("secondSection.title_ar")} />
                                </div>

                                <div className="flex flex-col gap-2">
                                    <Label className="font-bold">Sub Title</Label>
                                    <Input placeholder="Sub Title" {...register("secondSection.subTitle_ar")} />
                                </div>
                                ...
                                <div className="border p-3 rounded-md flex flex-col gap-4 mt-2">
                                    {secondSectionItems.map((field, index) => (
                                        ...
                                        >
                                            ...
                                            <Input
                                                placeholder="Letter"
                                                {...register(`secondSection.items.${index}.letter_ar`)}
                                            />
                                            ...
                                            <div className="flex flex-col gap-2">
                                                <div className="flex flex-col gap-2">
                                                    ...
                                                    <Input
                                                        type="text"
                                                        placeholder="Year"
                                                        {...register(`fourthSection.items.${index}.year_ar`)}
                                                    />
                                                </div>
                                            </div>
