...
const InteriorDesignPage = () => {
    ...
    const handleAddInteriorDesign = async (data: InteriorDesignProps) => {
        try {
            console.log("Clicked");
            const response = await fetch(`/api/admin/services/interior-design`, {
                method: "PATCH",
    ...
    useEffect(() => {
        fetchInteriorDesignData();
    }, []);

    return (
        <form className="grid grid-cols-2 gap-10" onSubmit={handleSubmit(handleAddInteriorDesign)}>
            {/*English Version */}
                        ...
                        <div>
                            ...
                            <div className="flex justify-end mt-2">
                                <Button
                                    ...
                                    addItem
                                    onClick={() =>
                                        fifthSectionAppend({ title: "", title_ar: "", description: "", description_ar: "" })
                                    }
                                >
                                    Add Item
                                </Button>
                                ...
                                {fifthSectionItems.map((field, index) => (
                                    ...
                                    >
                                        ...
                                        <div className="flex flex-col gap-2">
                                            <Label className="text-sm font-bold">Description</Label>
                                            <Controller
                                                name={`fifthSection.items.${index}.description_ar`}
                                                control={control}
                                                render={({ field }) => {
                                                    return <Textarea value={field.value} onChange={field.onChange} />;
                                                }}
