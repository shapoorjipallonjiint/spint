...
const InteriorDesignPage = () => {
    ...
    const { register, handleSubmit, setValue, control, formState: { errors } } = useForm<InteriorDesignProps>();
                ...
                <AdminItemContainer>
                    ...
                    <div className='p-5 rounded-md flex flex-col gap-5'>
                        ...
                        <div>
                                ...
                                <div className='flex justify-end mt-2'>
                                    <Button type='button' addItem onClick={() => fourthSectionAppend({ title: "", image: "", imageAlt: "", title_ar: "", imageAlt_ar: "", description: "", description_ar: "" })}>Add Item</Button>
                                </div>
                            </div>
                ...
                <AdminItemContainer>
                    ...
                    <div className='p-5 rounded-md flex flex-col gap-5'>
                        ...
                        <div>
                                ...
                                <div className='border p-2 rounded-md flex flex-col gap-5'>
                                    ...
                                    {fifthSectionItems.map((field, index) => (
                                        <div key={field.id} className='grid grid-cols-2 gap-2 relative border-b pb-5 last:border-b-0'>
                                            ...
                                            <div className='flex flex-col gap-2'>
                                                        <Label className="text-sm font-bold">Description</Label>
                                                        <Controller name={`fifthSection.items.${index}.description`} control={control} render={({ field }) => {
                                                            return <Textarea value={field.value} onChange={field.onChange} />
                                                        }} />
                                                    </div>
                                ...
                                <div className='flex justify-end mt-2'>
                                    <Button type='button' addItem onClick={() => fifthSectionAppend({ title: "", title_ar: "", description: "", description_ar: "" })}>Add Item</Button>
                                </div>
                            </div>
