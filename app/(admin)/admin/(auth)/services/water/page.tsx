...
const WaterPage = () => {
    ...
    const { register, handleSubmit, setValue, control, formState: { errors } } = useForm<WaterProps>();
                        ...
                        <div className='flex flex-col gap-2'>
                            ...
                            <div>
                                ...
                                <div className='flex justify-end mt-2'>
                                    <Button type='button' addItem onClick={() => secondSectionAppend({ title: "", image: "", imageAlt: "", logo: "", logoAlt: "", title_ar: "", imageAlt_ar: "", logoAlt_ar: "", description: "", description_ar: "" })}>Add Item</Button>
                                </div>
                            </div>
                                        ...
                                        <div key={field.id} className='grid grid-cols-2 gap-2 relative border-b pb-5 last:border-b-0'>
                                            ...
                                            <div className='flex flex-col gap-2'>
                                                ...
                                                <div className='flex flex-col gap-2'>
                                                    <div className='flex flex-col gap-2'>
                                                        <Label className='font-bold'>Alt Tag</Label>
                                                        <Input type='text' placeholder='Alt Tag' {...register(`secondSection.items.${index}.logoAlt_ar`)} />
                                                    </div>
                                                </div>
