...
const WaterPage = () => {
    ...
    const handleAddWater = async (data: WaterProps) => {
        try {
            const response = await fetch(`/api/admin/services/water`, {
                method: "PATCH",
    ...
    return (
        <form className="grid grid-cols-2 gap-10" onSubmit={handleSubmit(handleAddWater)}>
            {/*English Version */}
                                            ...
                                            <div className="flex flex-col gap-2">
                                                <div className="flex flex-col gap-2">
                                                    ...
                                                    {errors.secondSection?.items?.[index]?.logo && (
                                                        <p className="text-red-500">
                                                            {errors.secondSection?.items?.[index]?.logo.message}
                                                        </p>
                                                    )}
                                                </div>
                                                ...
                                                <div className="flex flex-col gap-2">
                                                    <div className="flex flex-col gap-2">
                                                        ...
                                                        <Input
                                                            type="text"
                                                            placeholder="Alt Tag"
                                                            {...register(`secondSection.items.${index}.logoAlt`)}
                                                        />
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div className="flex flex-col gap-2">
                                                    <div className="flex flex-col gap-2">
                                                        ...
                                                        <Input
                                                            type="text"
                                                            placeholder="Alt Tag"
                                                            {...register(`secondSection.items.${index}.logoAlt_ar`)}
                                                        />
                                                    </div>
                                                </div>
                                            </div>
